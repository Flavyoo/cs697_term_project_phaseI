...
def leakyrelu():
    ...
    for lmbda in [0.0, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1.0]:
        for j in range(RUNS):
            ...
            net.SGD("LReLU",training_data, EPOCHS, MB_SIZE, ETA, validation_data, test_data, lmbda=lmbda)
    return net
    ...
    for lmbda in [0.0, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1.0]:
        for j in range(RUNS):
            ...
            net = Network([
                ...
                SoftmaxLayer(n_in=100, n_out=2)], MB_SIZE)
            net.SGD("ELU",training_data, EPOCHS, MB_SIZE, ETA, validation_data, test_data, lmbda=lmbda)
    return net
