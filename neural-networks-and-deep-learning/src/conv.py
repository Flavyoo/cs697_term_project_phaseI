    ...
    for lmbda in [0.0, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1.0, 10.0, 100.0]:
        for j in range(1):
            ...
            net = Network([
                ...
                SoftmaxLayer(n_in=100, n_out=10)], mini_batch_size)
            net.SGD(training_data, 8, mini_batch_size, 0.03, validation_data, test_data, lmbda=lmbda)
    ...
    for lmbda in [0.0, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1.0]:
        for j in range(1):
            ...
            net = Network([
                ...
                SoftmaxLayer(n_in=100, n_out=10)], mini_batch_size)
            net.SGD(training_data, 6, mini_batch_size, 0.03, validation_data, test_data, lmbda=lmbda)
